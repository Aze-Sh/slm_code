import os
from ctypes import cdll,c_long,c_uint32,c_uint16,c_uint8,byref,create_string_buffer,c_bool, c_char, c_char_p,c_int,c_int16,c_int8,c_double,c_float,sizeof,c_voidp, Structure,CDLL
...
class TLPM:
	...
	def __init__(self):
		if sizeof(c_voidp) == 4:
			...
			self.dll = CDLL("C:\\Program Files\\IVI Foundation\\VISA\\Win64\\Bin\\TLPM_64")
